...
int main() {
  ...
  terminal::shape box1(
      term, terminal::attributes(0, 0, term.width(), term.height()), &welcome);

  terminal::button btn1(term,
                        terminal::attributes(0, 0, 10, 3,
                                             &box1.get_attributes(),
                                             anchor::center, anchor::center),
                        u"Button 1", &welcome);

  terminal::shape box2(term,
                       terminal::attributes(0, 0, 20, 20,
                                            &box1.get_attributes(),
                                            anchor::center, anchor::center),
                       &welcome);
  ...
  terminal::shape box3(
      term,
      terminal::attributes(0, 0, 10, 20, &box2.get_attributes(),
  ...
  terminal::shape box5(
      term,
      terminal::attributes(0, 0, 20, 10, &box2.get_attributes(),
  ...
  terminal::shape box7(
      term,
      terminal::attributes(0, 0, 15, 15, &box2.get_attributes(),
                           anchor::top_left, anchor::bottom_right),
      &welcome);

  int field_size = 7;

  terminal::field fld1(term,
                       terminal::attributes(0, 0, field_size, 3,
                                            &box7.get_attributes(),
                                            anchor::center, anchor::center),
  ...
  terminal::shape box8(
      term,
      terminal::attributes(0, 0, 10, 10, &box2.get_attributes(),
