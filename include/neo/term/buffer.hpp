...
public:
  struct term_cell {
    ...
    term_cell(wchar_t ch_ = ' ', color ch_color_ = color::white,
...
public:
  void fill_area(size_type const &x, size_type const &y, size_type const &width,
  ...
  void text(size_type const &x, size_type const &y,
